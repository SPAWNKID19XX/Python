...
book = [
    ...
    {'isbn': '0-385-50420-9', 'title': 'The Legend of Sleepy Hollow', 'publisher': 'The Sketch Book of Geoffrey Crayon',
     'publYear': 1820}
]
...
# create table author
cursor.execute(
    'CREATE TABLE if not exists author( id int NOT NULL AUTO_INCREMENT,FirstName varchar(50),LastName varchar(50) NOT NULL,isAlive BIT(1),PRIMARY KEY (id));')
cursor.execute(
    'CREATE TABLE if not exists book( isbn varchar(20) NOT NULL,title varchar(75),publisher varchar(50) NOT NULL,yearPubl int);')
cursor.execute(
    'CREATE TABLE if not exists user( id int NOT NULL AUTO_INCREMENT,FirstName varchar(50),LastName varchar(50) NOT NULL,Loan int,PRIMARY KEY (id));')

# insert to author
for obj in author:
    query = "INSERT INTO author ( FirstName, LastName, isAlive ) VALUES ('{}','{}',{});".format(obj['firstName'],
                                                                                                obj['lastName'],
                                                                                                int(obj['isAlive']))
    # print(query)
...
# insert to book
for obj in book:
    query = "INSERT INTO book ( isbn, title, publisher,yearPubl ) VALUES ('{}','{}','{}', {});".format(obj['isbn'],
                                                                                                       obj['title'],
                                                                                                       obj['publisher'],
                                                                                                       obj['publYear'])
    # print(query)
...
# insert to user
for obj in user:
    query = "INSERT INTO user ( FirstName, LastName, Loan ) VALUES ('{}','{}',{});".format(obj['firstName'],
                                                                                           obj['lastName'], obj['loan'])
    # print(query)
    cursor.execute(query)
connect.commit()
...
cursor.execute('select FirstName FROM user where Loan > 10 ')
users = cursor.fetchall()
for user in users:
    print(user)