...
activos = [superherois['membros'][0], superherois['membros'][2]]
inactivos = [superherois['membros'][1]]

#Change structur
superherois['membros'].clear()#Clear all list members
superherois['membros'] = { #save 2 new lists to dict
    'activos' : activos,
    'inactovos': inactivos
}
